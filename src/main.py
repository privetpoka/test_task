...
######
try:
	f_data=open('./../res/data_set.csv','r') #set for eduaction with excluded the last twenty parameters
	f_target=open('./../res/target.csv','r') 
	check_data=open('./../res/data_set_check.csv','r') # full setl for checking how our model is working
	target_data_check=open('./../res/target_check.csv','r')
